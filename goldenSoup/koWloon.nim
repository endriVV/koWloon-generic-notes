...
proc main(bootstarter : bool) =
  ...
  proc openGUI() =
    ...
    menuEdit.enable(menuEdit.findText("Notes to Nodes\tCtrl+P"))
    menuEdit.enable(menuEdit.findText("Notes to Sub-Nodes"))
    menuEdit.enable(menuEdit.findText("Notes to Sub-Nodes [Pivot]"))
    menuEdit.enable(menuEdit.findText("Notes to line-by-line Notes"))
    menuCopy.enable(menuCopy.findText("Paste\tF8"))
  ...
  proc activateSearch() =
    ...
    menuEdit.disable(menuEdit.findText("Notes to Sub-Nodes [Pivot]"))
