...
prefstitles.add("Coal Color Theme")
prefstitles.add("Dolphin Theme")
prefstitles.add("Dracula Theme")
prefstitles.add("Random Theme")
...
prefnotes.add("Sets the Color Scheme of the app to Coal")
prefnotes.add("Sets the Color Scheme of the app to Dolphin")
prefnotes.add("Sets the Color Scheme of the app to Dracula")
prefnotes.add("Sets a Random theme every start")
